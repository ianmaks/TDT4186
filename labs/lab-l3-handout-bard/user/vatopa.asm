...
int main(int argc, char const *argv[])
{
  ...
  18:	1dc080e7          	jalr	476(ra) # 1f0 <atoi>
  1c:	892a                	mv	s2,a0
    int pid = 0;
  ...
  20:	4581                	li	a1,0
    if(argc > 2)
  22:	0337c863          	blt	a5,s3,52 <main+0x52>
        pid = atoi(argv[2]);
  ...
  2c:	380080e7          	jalr	896(ra) # 3a8 <va2pa>
  30:	85aa                	mv	a1,a0
  32:	00001517          	auipc	a0,0x1
  36:	80e50513          	addi	a0,a0,-2034 # 840 <malloc+0xf2>
  3a:	00000097          	auipc	ra,0x0
  3e:	656080e7          	jalr	1622(ra) # 690 <printf>
  ...
  58:	19c080e7          	jalr	412(ra) # 1f0 <atoi>
  5c:	85aa                	mv	a1,a0
  5e:	b7e1                	j	26 <main+0x26>
