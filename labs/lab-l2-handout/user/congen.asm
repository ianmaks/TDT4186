...
void forktest(void)
{
  ...
  46:	84e50513          	addi	a0,a0,-1970 # 890 <malloc+0xec>
  ...
  70:	844b0b13          	addi	s6,s6,-1980 # 8b0 <malloc+0x10c>
            printf("CHILD %d: %d\n", n, i);
  74:	00001a97          	auipc	s5,0x1
  78:	82ca8a93          	addi	s5,s5,-2004 # 8a0 <malloc+0xfc>
    for (unsigned long long i = 0; i < 100; i++)
  ...
  8a:	666080e7          	jalr	1638(ra) # 6ec <printf>
    for (unsigned long long i = 0; i < 100; i++)
  ...
  a2:	64e080e7          	jalr	1614(ra) # 6ec <printf>
  ...
  ac:	81850513          	addi	a0,a0,-2024 # 8c0 <malloc+0x11c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46c:	4c850513          	addi	a0,a0,1224 # 930 <digits>
 470:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	36c70713          	addi	a4,a4,876 # 8d8 <malloc+0x134>
 ...
 5fa:	33ab8b93          	addi	s7,s7,826 # 930 <digits>
 ...
 64e:	28690913          	addi	s2,s2,646 # 8d0 <malloc+0x12c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 87e:	b7a080e7          	jalr	-1158(ra) # 3f4 <sbrk>
  if(p == (char*)-1)
