...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	08250513          	addi	a0,a0,130 # 60c0 <malloc+0xea>
      ...
      74:	8082                	ret
{
      ...
      84:	06050513          	addi	a0,a0,96 # 60e0 <malloc+0x10a>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	05050513          	addi	a0,a0,80 # 60f8 <malloc+0x122>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	05250513          	addi	a0,a0,82 # 6118 <malloc+0x142>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	01a50513          	addi	a0,a0,26 # 6100 <malloc+0x12a>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	02650513          	addi	a0,a0,38 # 6128 <malloc+0x152>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	02450513          	addi	a0,a0,36 # 6150 <malloc+0x17a>
     134:	00006097          	auipc	ra,0x6
     138:	aaa080e7          	jalr	-1366(ra) # 5bde <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	01050513          	addi	a0,a0,16 # 6150 <malloc+0x17a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	00c58593          	addi	a1,a1,12 # 6160 <malloc+0x18a>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	fe850513          	addi	a0,a0,-24 # 6150 <malloc+0x17a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	fec58593          	addi	a1,a1,-20 # 6168 <malloc+0x192>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fbc50513          	addi	a0,a0,-68 # 6150 <malloc+0x17a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fa650513          	addi	a0,a0,-90 # 6170 <malloc+0x19a>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f1c50513          	addi	a0,a0,-228 # 6198 <malloc+0x1c2>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f08a8a93          	addi	s5,s5,-248 # 6198 <malloc+0x1c2>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e9650513          	addi	a0,a0,-362 # 61a8 <malloc+0x1d2>
     ...
     338:	e9450513          	addi	a0,a0,-364 # 61c8 <malloc+0x1f2>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	e8250513          	addi	a0,a0,-382 # 61e0 <malloc+0x20a>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	e6e98993          	addi	s3,s3,-402 # 61e0 <malloc+0x20a>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e2250513          	addi	a0,a0,-478 # 61e0 <malloc+0x20a>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	d9258593          	addi	a1,a1,-622 # 6168 <malloc+0x192>
    ...
    printf("write failed\n");
     ...
     3f0:	e1450513          	addi	a0,a0,-492 # 6200 <malloc+0x22a>
    ...
    exit(1);
     ...
     40a:	de250513          	addi	a0,a0,-542 # 61e8 <malloc+0x212>
    ...
    printf("open junk failed\n");
     ...
     424:	dc850513          	addi	a0,a0,-568 # 61e8 <malloc+0x212>
  ...
  unlink("junk");
     ...
     448:	d9c50513          	addi	a0,a0,-612 # 61e0 <malloc+0x20a>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	cc0a0a13          	addi	s4,s4,-832 # 6210 <malloc+0x23a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c1c50513          	addi	a0,a0,-996 # 6218 <malloc+0x242>
     ...
     61e:	c1650513          	addi	a0,a0,-1002 # 6230 <malloc+0x25a>
     ...
     63c:	c2850513          	addi	a0,a0,-984 # 6260 <malloc+0x28a>
     ...
     656:	c3e50513          	addi	a0,a0,-962 # 6290 <malloc+0x2ba>
     ...
     674:	c3050513          	addi	a0,a0,-976 # 62a0 <malloc+0x2ca>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c22a0a13          	addi	s4,s4,-990 # 62d0 <malloc+0x2fa>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	ab2a8a93          	addi	s5,s5,-1358 # 6168 <malloc+0x192>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	b7c50513          	addi	a0,a0,-1156 # 62d8 <malloc+0x302>
     ...
     77e:	b7650513          	addi	a0,a0,-1162 # 62f0 <malloc+0x31a>
     ...
     798:	afc50513          	addi	a0,a0,-1284 # 6290 <malloc+0x2ba>
     ...
     7b2:	b7250513          	addi	a0,a0,-1166 # 6320 <malloc+0x34a>
     ...
     7d0:	b6c50513          	addi	a0,a0,-1172 # 6338 <malloc+0x362>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	93e58593          	addi	a1,a1,-1730 # 6160 <malloc+0x18a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	91250513          	addi	a0,a0,-1774 # 6150 <malloc+0x17a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	8e650513          	addi	a0,a0,-1818 # 6150 <malloc+0x17a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	8d250513          	addi	a0,a0,-1838 # 6150 <malloc+0x17a>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b0c58593          	addi	a1,a1,-1268 # 63c8 <malloc+0x3f2>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	85250513          	addi	a0,a0,-1966 # 6150 <malloc+0x17a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a2650513          	addi	a0,a0,-1498 # 6368 <malloc+0x392>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a2a50513          	addi	a0,a0,-1494 # 6388 <malloc+0x3b2>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	a2650513          	addi	a0,a0,-1498 # 6398 <malloc+0x3c2>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a2a50513          	addi	a0,a0,-1494 # 63b8 <malloc+0x3e2>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	9f650513          	addi	a0,a0,-1546 # 6398 <malloc+0x3c2>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a1050513          	addi	a0,a0,-1520 # 63d0 <malloc+0x3fa>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a1250513          	addi	a0,a0,-1518 # 63f0 <malloc+0x41a>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	9fe50513          	addi	a0,a0,-1538 # 6410 <malloc+0x43a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a0e98993          	addi	s3,s3,-1522 # 6438 <malloc+0x462>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a3ea8a93          	addi	s5,s5,-1474 # 6470 <malloc+0x49a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	99850513          	addi	a0,a0,-1640 # 6410 <malloc+0x43a>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	95c50513          	addi	a0,a0,-1700 # 6410 <malloc+0x43a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	93a50513          	addi	a0,a0,-1734 # 6418 <malloc+0x442>
    ...
    exit(1);
     ...
     b00:	94c50513          	addi	a0,a0,-1716 # 6448 <malloc+0x472>
     ...
     b1e:	96650513          	addi	a0,a0,-1690 # 6480 <malloc+0x4aa>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	97250513          	addi	a0,a0,-1678 # 64a8 <malloc+0x4d2>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	97650513          	addi	a0,a0,-1674 # 64c8 <malloc+0x4f2>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	97250513          	addi	a0,a0,-1678 # 64e0 <malloc+0x50a>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	96050513          	addi	a0,a0,-1696 # 6500 <malloc+0x52a>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	90e50513          	addi	a0,a0,-1778 # 6500 <malloc+0x52a>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	8ce50513          	addi	a0,a0,-1842 # 6508 <malloc+0x532>
    ...
    exit(1);
     ...
     c5c:	8d050513          	addi	a0,a0,-1840 # 6528 <malloc+0x552>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	8dc50513          	addi	a0,a0,-1828 # 6550 <malloc+0x57a>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	86050513          	addi	a0,a0,-1952 # 6500 <malloc+0x52a>
     ...
     cd0:	8a450513          	addi	a0,a0,-1884 # 6570 <malloc+0x59a>
     ...
     cee:	8ae50513          	addi	a0,a0,-1874 # 6598 <malloc+0x5c2>
     ...
     d0c:	8a850513          	addi	a0,a0,-1880 # 65b0 <malloc+0x5da>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8b450513          	addi	a0,a0,-1868 # 65d8 <malloc+0x602>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	89e50513          	addi	a0,a0,-1890 # 65f0 <malloc+0x61a>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8b658593          	addi	a1,a1,-1866 # 6620 <malloc+0x64a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	86a50513          	addi	a0,a0,-1942 # 65f0 <malloc+0x61a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	85450513          	addi	a0,a0,-1964 # 65f0 <malloc+0x61a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	83e50513          	addi	a0,a0,-1986 # 65f0 <malloc+0x61a>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8a258593          	addi	a1,a1,-1886 # 6668 <malloc+0x692>
  ...
  unlink("unlinkread");
     ...
     e32:	7c250513          	addi	a0,a0,1986 # 65f0 <malloc+0x61a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7b250513          	addi	a0,a0,1970 # 6600 <malloc+0x62a>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7be50513          	addi	a0,a0,1982 # 6628 <malloc+0x652>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	7c250513          	addi	a0,a0,1986 # 6648 <malloc+0x672>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	7ce50513          	addi	a0,a0,1998 # 6670 <malloc+0x69a>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	7d250513          	addi	a0,a0,2002 # 6690 <malloc+0x6ba>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	7d650513          	addi	a0,a0,2006 # 66b0 <malloc+0x6da>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	6e258593          	addi	a1,a1,1762 # 6620 <malloc+0x64a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	77a58593          	addi	a1,a1,1914 # 66d8 <malloc+0x702>
     f66:	00005517          	auipc	a0,0x5
     f6a:	76a50513          	addi	a0,a0,1898 # 66d0 <malloc+0x6fa>
  ...
  unlink("lf1");
     ...
     f7e:	75650513          	addi	a0,a0,1878 # 66d0 <malloc+0x6fa>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	74450513          	addi	a0,a0,1860 # 66d0 <malloc+0x6fa>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	73650513          	addi	a0,a0,1846 # 66d8 <malloc+0x702>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	6fe58593          	addi	a1,a1,1790 # 66d8 <malloc+0x702>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	6e850513          	addi	a0,a0,1768 # 66d8 <malloc+0x702>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	6d058593          	addi	a1,a1,1744 # 66d0 <malloc+0x6fa>
    1008:	00005517          	auipc	a0,0x5
    100c:	6d050513          	addi	a0,a0,1744 # 66d8 <malloc+0x702>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	6b458593          	addi	a1,a1,1716 # 66d0 <malloc+0x6fa>
    1024:	00005517          	auipc	a0,0x5
    1028:	7bc50513          	addi	a0,a0,1980 # 67e0 <malloc+0x80a>
    ...
    104a:	69a50513          	addi	a0,a0,1690 # 66e0 <malloc+0x70a>
    ...
    1066:	69650513          	addi	a0,a0,1686 # 66f8 <malloc+0x722>
    ...
    1082:	69250513          	addi	a0,a0,1682 # 6710 <malloc+0x73a>
    ...
    109e:	69650513          	addi	a0,a0,1686 # 6730 <malloc+0x75a>
    ...
    10ba:	6aa50513          	addi	a0,a0,1706 # 6760 <malloc+0x78a>
    ...
    10d6:	6a650513          	addi	a0,a0,1702 # 6778 <malloc+0x7a2>
    ...
    10f2:	6a250513          	addi	a0,a0,1698 # 6790 <malloc+0x7ba>
    ...
    110e:	6ae50513          	addi	a0,a0,1710 # 67b8 <malloc+0x7e2>
    ...
    112a:	6c250513          	addi	a0,a0,1730 # 67e8 <malloc+0x812>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	6b098993          	addi	s3,s3,1712 # 6808 <malloc+0x832>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	68450513          	addi	a0,a0,1668 # 6818 <malloc+0x842>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	63ea0a13          	addi	s4,s4,1598 # 6838 <malloc+0x862>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	5ec50513          	addi	a0,a0,1516 # 6838 <malloc+0x862>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	58450513          	addi	a0,a0,1412 # 6840 <malloc+0x86a>
    ...
    12e0:	58450513          	addi	a0,a0,1412 # 6860 <malloc+0x88a>
    ...
    12fc:	58850513          	addi	a0,a0,1416 # 6880 <malloc+0x8aa>
...
000000000000134a <badarg>:
{
    ...
    1368:	d9498993          	addi	s3,s3,-620 # 60f8 <malloc+0x122>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	6ea78793          	addi	a5,a5,1770 # 7ad8 <malloc+0x1b02>
  ...
  if(pid == 0){
    ...
    144e:	0ce78793          	addi	a5,a5,206 # 8518 <malloc+0x2542>
    ...
    1472:	c8a50513          	addi	a0,a0,-886 # 60f8 <malloc+0x122>
    ...
    148a:	4a250513          	addi	a0,a0,1186 # 6928 <malloc+0x952>
    ...
    14aa:	3fa50513          	addi	a0,a0,1018 # 68a0 <malloc+0x8ca>
    ...
    14ca:	3fa50513          	addi	a0,a0,1018 # 68c0 <malloc+0x8ea>
    ...
    14ec:	3f850513          	addi	a0,a0,1016 # 68e0 <malloc+0x90a>
    ...
    150c:	40050513          	addi	a0,a0,1024 # 6908 <malloc+0x932>
    ...
    1526:	86650513          	addi	a0,a0,-1946 # 6d88 <malloc+0xdb2>
  ...
  if(st != 747){
    ...
    1570:	3e450513          	addi	a0,a0,996 # 6950 <malloc+0x97a>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	bb250513          	addi	a0,a0,-1102 # 6150 <malloc+0x17a>
  ...
  if(pid == 0){
    ...
    15cc:	b88a0a13          	addi	s4,s4,-1144 # 6150 <malloc+0x17a>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	3e0a8a93          	addi	s5,s5,992 # 69b0 <malloc+0x9da>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	34050513          	addi	a0,a0,832 # 6980 <malloc+0x9aa>
    ...
    1660:	33c50513          	addi	a0,a0,828 # 6998 <malloc+0x9c2>
    ...
    167e:	34650513          	addi	a0,a0,838 # 69c0 <malloc+0x9ea>
    ...
    169c:	ab8a0a13          	addi	s4,s4,-1352 # 6150 <malloc+0x17a>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	340a8a93          	addi	s5,s5,832 # 69e0 <malloc+0xa0a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	a6650513          	addi	a0,a0,-1434 # 6150 <malloc+0x17a>
  ...
  exit(xstatus);
    ...
    170c:	29050513          	addi	a0,a0,656 # 6998 <malloc+0x9c2>
    ...
    172a:	2c250513          	addi	a0,a0,706 # 69e8 <malloc+0xa12>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9aa78793          	addi	a5,a5,-1622 # 60f8 <malloc+0x122>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2ae78793          	addi	a5,a5,686 # 6a08 <malloc+0xa32>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2a650513          	addi	a0,a0,678 # 6a10 <malloc+0xa3a>
  ...
  if(pid == 0) {
    ...
    179c:	27850513          	addi	a0,a0,632 # 6a10 <malloc+0xa3a>
    ...
    17b8:	27c50513          	addi	a0,a0,636 # 6a30 <malloc+0xa5a>
    ...
    17d4:	1b050513          	addi	a0,a0,432 # 6980 <malloc+0x9aa>
    ...
    17f0:	22c50513          	addi	a0,a0,556 # 6a18 <malloc+0xa42>
    ...
    180e:	8ee50513          	addi	a0,a0,-1810 # 60f8 <malloc+0x122>
  ...
  if(xstatus != 0)
    ...
    1842:	20250513          	addi	a0,a0,514 # 6a40 <malloc+0xa6a>
    ...
    185e:	1fe50513          	addi	a0,a0,510 # 6a58 <malloc+0xa82>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	1a250513          	addi	a0,a0,418 # 6a10 <malloc+0xa3a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c3050513          	addi	a0,a0,-976 # 64c8 <malloc+0x4f2>
    ...
    18b8:	0e450513          	addi	a0,a0,228 # 6998 <malloc+0x9c2>
  ...
  unlink("echo-ok");
    ...
    18d2:	14250513          	addi	a0,a0,322 # 6a10 <malloc+0xa3a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	17850513          	addi	a0,a0,376 # 6a70 <malloc+0xa9a>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	0d050513          	addi	a0,a0,208 # 6a88 <malloc+0xab2>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	06250513          	addi	a0,a0,98 # 6aa0 <malloc+0xaca>
    ...
    1a5e:	05e50513          	addi	a0,a0,94 # 6ab8 <malloc+0xae2>
    ...
    1a90:	04450513          	addi	a0,a0,68 # 6ad0 <malloc+0xafa>
    ...
    1ad0:	02450513          	addi	a0,a0,36 # 6af0 <malloc+0xb1a>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e4250513          	addi	a0,a0,-446 # 6980 <malloc+0x9aa>
    ...
    1b5e:	fae50513          	addi	a0,a0,-82 # 6b08 <malloc+0xb32>
    ...
    1b7a:	faa50513          	addi	a0,a0,-86 # 6b20 <malloc+0xb4a>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	d9250513          	addi	a0,a0,-622 # 6980 <malloc+0x9aa>
    ...
    1c16:	d6e50513          	addi	a0,a0,-658 # 6980 <malloc+0x9aa>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	eb450513          	addi	a0,a0,-332 # 6b40 <malloc+0xb6a>
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	e6c50513          	addi	a0,a0,-404 # 6b50 <malloc+0xb7a>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	05650513          	addi	a0,a0,86 # 6d88 <malloc+0xdb2>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	fb850513          	addi	a0,a0,-72 # 6d88 <malloc+0xdb2>
    ...
    1e00:	c1c50513          	addi	a0,a0,-996 # 6a18 <malloc+0xa42>
    ...
    1e72:	d0250513          	addi	a0,a0,-766 # 6b70 <malloc+0xb9a>
    ...
    1ea6:	ce650513          	addi	a0,a0,-794 # 6b88 <malloc+0xbb2>
    ...
    1f0c:	ca850513          	addi	a0,a0,-856 # 6bb0 <malloc+0xbda>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	1c050513          	addi	a0,a0,448 # 6168 <malloc+0x192>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	184a8a93          	addi	s5,s5,388 # 6168 <malloc+0x192>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	becb8b93          	addi	s7,s7,-1044 # 6bd8 <malloc+0xc02>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	98850513          	addi	a0,a0,-1656 # 6980 <malloc+0x9aa>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b3e50513          	addi	a0,a0,-1218 # 6bf8 <malloc+0xc22>
  ...
  if(wait(0) != -1){
    ...
    2120:	ac450513          	addi	a0,a0,-1340 # 6be0 <malloc+0xc0a>
    ...
    213c:	ae850513          	addi	a0,a0,-1304 # 6c20 <malloc+0xc4a>
    ...
    2158:	ae450513          	addi	a0,a0,-1308 # 6c38 <malloc+0xc62>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7ac50513          	addi	a0,a0,1964 # 6980 <malloc+0x9aa>
    ...
    21fa:	a5a50513          	addi	a0,a0,-1446 # 6c50 <malloc+0xc7a>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	70850513          	addi	a0,a0,1800 # 6980 <malloc+0x9aa>
    ...
    22a8:	9cc50513          	addi	a0,a0,-1588 # 6c70 <malloc+0xc9a>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9b450513          	addi	a0,a0,-1612 # 6c88 <malloc+0xcb2>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	98250513          	addi	a0,a0,-1662 # 6c88 <malloc+0xcb2>
  ...
  close(fd);
    ...
    2340:	95c70713          	addi	a4,a4,-1700 # 6c98 <malloc+0xcc2>
    ...
    2394:	9e850513          	addi	a0,a0,-1560 # 6d78 <malloc+0xda2>
    ...
    23b8:	9e450513          	addi	a0,a0,-1564 # 6d98 <malloc+0xdc2>
...
r_sp()
{
    ...
    2416:	9a650513          	addi	a0,a0,-1626 # 6db8 <malloc+0xde2>
    ...
    2432:	55250513          	addi	a0,a0,1362 # 6980 <malloc+0x9aa>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	4e450513          	addi	a0,a0,1252 # 6980 <malloc+0x9aa>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	87050513          	addi	a0,a0,-1936 # 6d88 <malloc+0xdb2>
    ...
    25cc:	81850513          	addi	a0,a0,-2024 # 6de0 <malloc+0xe0a>
    ...
    25ec:	be050513          	addi	a0,a0,-1056 # 61c8 <malloc+0x1f2>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	45878793          	addi	a5,a5,1112 # 7ad8 <malloc+0x1b02>
  ...
  if(ret != -1){
    ...
    26c6:	73650513          	addi	a0,a0,1846 # 6df8 <malloc+0xe22>
    ...
    26e4:	1c050513          	addi	a0,a0,448 # 68a0 <malloc+0x8ca>
    ...
    2702:	1c250513          	addi	a0,a0,450 # 68c0 <malloc+0x8ea>
    ...
    2722:	1c250513          	addi	a0,a0,450 # 68e0 <malloc+0x90a>
    ...
    2740:	1cc50513          	addi	a0,a0,460 # 6908 <malloc+0x932>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	6b050513          	addi	a0,a0,1712 # 6e38 <malloc+0xe62>
  ...
  if(n >= 0){
    ...
    27bc:	6a050513          	addi	a0,a0,1696 # 6e58 <malloc+0xe82>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	75e080e7          	jalr	1886(ra) # 5f1e <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	62e50513          	addi	a0,a0,1582 # 6e00 <malloc+0xe2a>
    27da:	00003097          	auipc	ra,0x3
    27de:	744080e7          	jalr	1860(ra) # 5f1e <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	62c50513          	addi	a0,a0,1580 # 6e18 <malloc+0xe42>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	72a080e7          	jalr	1834(ra) # 5f1e <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	63a50513          	addi	a0,a0,1594 # 6e40 <malloc+0xe6a>
    280e:	00003097          	auipc	ra,0x3
    2812:	710080e7          	jalr	1808(ra) # 5f1e <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	60e50513          	addi	a0,a0,1550 # 6e38 <malloc+0xe62>
    2832:	00003097          	auipc	ra,0x3
    2836:	3ac080e7          	jalr	940(ra) # 5bde <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	a9450513          	addi	a0,a0,-1388 # 62d0 <malloc+0x2fa>
  ...
  if(n >= 0){
    ...
    286a:	62250513          	addi	a0,a0,1570 # 6e88 <malloc+0xeb2>
    286e:	00003097          	auipc	ra,0x3
    2872:	6b0080e7          	jalr	1712(ra) # 5f1e <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	5c050513          	addi	a0,a0,1472 # 6e40 <malloc+0xe6a>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	5b050513          	addi	a0,a0,1456 # 6eb0 <malloc+0xeda>
    2908:	00003097          	auipc	ra,0x3
    290c:	616080e7          	jalr	1558(ra) # 5f1e <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	57e50513          	addi	a0,a0,1406 # 6ed0 <malloc+0xefa>
    295a:	00003097          	auipc	ra,0x3
    295e:	5c4080e7          	jalr	1476(ra) # 5f1e <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	57a50513          	addi	a0,a0,1402 # 6f30 <malloc+0xf5a>
    29be:	00003097          	auipc	ra,0x3
    29c2:	560080e7          	jalr	1376(ra) # 5f1e <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	51850513          	addi	a0,a0,1304 # 6ef0 <malloc+0xf1a>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	53e080e7          	jalr	1342(ra) # 5f1e <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	51c50513          	addi	a0,a0,1308 # 6f10 <malloc+0xf3a>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	522080e7          	jalr	1314(ra) # 5f1e <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	41250513          	addi	a0,a0,1042 # 6f50 <malloc+0xf7a>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	3d8080e7          	jalr	984(ra) # 5f1e <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	43e50513          	addi	a0,a0,1086 # 6f98 <malloc+0xfc2>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	3bc080e7          	jalr	956(ra) # 5f1e <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	43e50513          	addi	a0,a0,1086 # 6fb8 <malloc+0xfe2>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	39c080e7          	jalr	924(ra) # 5f1e <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	45e50513          	addi	a0,a0,1118 # 6ff8 <malloc+0x1022>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	37c080e7          	jalr	892(ra) # 5f1e <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	47250513          	addi	a0,a0,1138 # 7028 <malloc+0x1052>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	360080e7          	jalr	864(ra) # 5f1e <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	48a50513          	addi	a0,a0,1162 # 7060 <malloc+0x108a>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	340080e7          	jalr	832(ra) # 5f1e <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	47850513          	addi	a0,a0,1144 # 7088 <malloc+0x10b2>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	46650513          	addi	a0,a0,1126 # 7088 <malloc+0x10b2>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	41a50513          	addi	a0,a0,1050 # 7090 <malloc+0x10ba>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	2a0080e7          	jalr	672(ra) # 5f1e <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	41650513          	addi	a0,a0,1046 # 70a8 <malloc+0x10d2>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	284080e7          	jalr	644(ra) # 5f1e <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	dda50513          	addi	a0,a0,-550 # 6a88 <malloc+0xab2>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	268080e7          	jalr	616(ra) # 5f1e <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	3e850513          	addi	a0,a0,1000 # 70c0 <malloc+0x10ea>
  ...
  close(fd);
    ...
    2d24:	c7850513          	addi	a0,a0,-904 # 6998 <malloc+0x9c2>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	1f6080e7          	jalr	502(ra) # 5f1e <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	01a50513          	addi	a0,a0,26 # 6d88 <malloc+0xdb2>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1a8080e7          	jalr	424(ra) # 5f1e <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	fc450513          	addi	a0,a0,-60 # 6d88 <malloc+0xdb2>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	152080e7          	jalr	338(ra) # 5f1e <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	f6450513          	addi	a0,a0,-156 # 6d88 <malloc+0xdb2>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	0f2080e7          	jalr	242(ra) # 5f1e <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	df050513          	addi	a0,a0,-528 # 6d88 <malloc+0xdb2>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	f7e080e7          	jalr	-130(ra) # 5f1e <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	10c50513          	addi	a0,a0,268 # 60f8 <malloc+0x122>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	17078793          	addi	a5,a5,368 # 6168 <malloc+0x192>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	26e50513          	addi	a0,a0,622 # 7298 <malloc+0x12c2>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	0b450513          	addi	a0,a0,180 # 70f0 <malloc+0x111a>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	0f650513          	addi	a0,a0,246 # 7148 <malloc+0x1172>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	15050513          	addi	a0,a0,336 # 71c0 <malloc+0x11ea>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1a450513          	addi	a0,a0,420 # 7230 <malloc+0x125a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	1ea50513          	addi	a0,a0,490 # 7288 <malloc+0x12b2>
  ...
  unlink("12345678901234");
    ...
    3104:	19850513          	addi	a0,a0,408 # 7298 <malloc+0x12c2>
    ...
    3120:	fac50513          	addi	a0,a0,-84 # 70c8 <malloc+0x10f2>
    3124:	00003097          	auipc	ra,0x3
    3128:	dfa080e7          	jalr	-518(ra) # 5f1e <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	fd850513          	addi	a0,a0,-40 # 7110 <malloc+0x113a>
    3140:	00003097          	auipc	ra,0x3
    3144:	dde080e7          	jalr	-546(ra) # 5f1e <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	02450513          	addi	a0,a0,36 # 7178 <malloc+0x11a2>
    315c:	00003097          	auipc	ra,0x3
    3160:	dc2080e7          	jalr	-574(ra) # 5f1e <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	08050513          	addi	a0,a0,128 # 71f0 <malloc+0x121a>
    3178:	00003097          	auipc	ra,0x3
    317c:	da6080e7          	jalr	-602(ra) # 5f1e <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	0c450513          	addi	a0,a0,196 # 7250 <malloc+0x127a>
    3194:	00003097          	auipc	ra,0x3
    3198:	d8a080e7          	jalr	-630(ra) # 5f1e <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	10050513          	addi	a0,a0,256 # 72a8 <malloc+0x12d2>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	d6e080e7          	jalr	-658(ra) # 5f1e <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	0ec50513          	addi	a0,a0,236 # 72e0 <malloc+0x130a>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	0d250513          	addi	a0,a0,210 # 72f0 <malloc+0x131a>
    3226:	00003097          	auipc	ra,0x3
    322a:	cf8080e7          	jalr	-776(ra) # 5f1e <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	03250513          	addi	a0,a0,50 # 72e0 <malloc+0x130a>
  ...
  unlink("diskfulldir");
    ...
    32c6:	01e50513          	addi	a0,a0,30 # 72e0 <malloc+0x130a>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f2050513          	addi	a0,a0,-224 # 7310 <malloc+0x133a>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b26080e7          	jalr	-1242(ra) # 5f1e <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f3250513          	addi	a0,a0,-206 # 7340 <malloc+0x136a>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f1e50513          	addi	a0,a0,-226 # 7340 <malloc+0x136a>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f4a50513          	addi	a0,a0,-182 # 7380 <malloc+0x13aa>
  ...
  if(chdir("/") < 0){
    ...
    344e:	f6650513          	addi	a0,a0,-154 # 73b0 <malloc+0x13da>
    ...
    346e:	ede50513          	addi	a0,a0,-290 # 7348 <malloc+0x1372>
    3472:	00003097          	auipc	ra,0x3
    3476:	aac080e7          	jalr	-1364(ra) # 5f1e <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	eda50513          	addi	a0,a0,-294 # 7360 <malloc+0x138a>
    348e:	00003097          	auipc	ra,0x3
    3492:	a90080e7          	jalr	-1392(ra) # 5f1e <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	eee50513          	addi	a0,a0,-274 # 7390 <malloc+0x13ba>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	a74080e7          	jalr	-1420(ra) # 5f1e <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	efa50513          	addi	a0,a0,-262 # 73b8 <malloc+0x13e2>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a58080e7          	jalr	-1448(ra) # 5f1e <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e4e50513          	addi	a0,a0,-434 # 7340 <malloc+0x136a>
    ...
    350a:	e3a50513          	addi	a0,a0,-454 # 7340 <malloc+0x136a>
    ...
    351e:	e6650513          	addi	a0,a0,-410 # 7380 <malloc+0x13aa>
    ...
    353e:	44650513          	addi	a0,a0,1094 # 6980 <malloc+0x9aa>
    3542:	00003097          	auipc	ra,0x3
    3546:	9dc080e7          	jalr	-1572(ra) # 5f1e <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	df250513          	addi	a0,a0,-526 # 7348 <malloc+0x1372>
    355e:	00003097          	auipc	ra,0x3
    3562:	9c0080e7          	jalr	-1600(ra) # 5f1e <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e5e50513          	addi	a0,a0,-418 # 73d0 <malloc+0x13fa>
    357a:	00003097          	auipc	ra,0x3
    357e:	9a4080e7          	jalr	-1628(ra) # 5f1e <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e0250513          	addi	a0,a0,-510 # 7390 <malloc+0x13ba>
    3596:	00003097          	auipc	ra,0x3
    359a:	988080e7          	jalr	-1656(ra) # 5f1e <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e1c50513          	addi	a0,a0,-484 # 73e8 <malloc+0x1412>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e0850513          	addi	a0,a0,-504 # 73e8 <malloc+0x1412>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e1450513          	addi	a0,a0,-492 # 7408 <malloc+0x1432>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	de050513          	addi	a0,a0,-544 # 73e8 <malloc+0x1412>
    ...
    362c:	d2050513          	addi	a0,a0,-736 # 7348 <malloc+0x1372>
    3630:	00003097          	auipc	ra,0x3
    3634:	8ee080e7          	jalr	-1810(ra) # 5f1e <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dac50513          	addi	a0,a0,-596 # 73f0 <malloc+0x141a>
    364c:	00003097          	auipc	ra,0x3
    3650:	8d2080e7          	jalr	-1838(ra) # 5f1e <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	db050513          	addi	a0,a0,-592 # 7410 <malloc+0x143a>
    3668:	00003097          	auipc	ra,0x3
    366c:	8b6080e7          	jalr	-1866(ra) # 5f1e <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dac50513          	addi	a0,a0,-596 # 7428 <malloc+0x1452>
    3684:	00003097          	auipc	ra,0x3
    3688:	89a080e7          	jalr	-1894(ra) # 5f1e <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	ecc50513          	addi	a0,a0,-308 # 7570 <malloc+0x159a>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	d8c50513          	addi	a0,a0,-628 # 7440 <malloc+0x146a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	d9450513          	addi	a0,a0,-620 # 7460 <malloc+0x148a>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	e8c58593          	addi	a1,a1,-372 # 7570 <malloc+0x159a>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d4250513          	addi	a0,a0,-702 # 7440 <malloc+0x146a>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	da650513          	addi	a0,a0,-602 # 74b8 <malloc+0x14e2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	db650513          	addi	a0,a0,-586 # 74e0 <malloc+0x150a>
  ...
  write(fd, "FF", 2);
    ...
    3746:	dce58593          	addi	a1,a1,-562 # 7510 <malloc+0x153a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	dba50513          	addi	a0,a0,-582 # 7518 <malloc+0x1542>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	dc258593          	addi	a1,a1,-574 # 7568 <malloc+0x1592>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d3250513          	addi	a0,a0,-718 # 74e0 <malloc+0x150a>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d1e50513          	addi	a0,a0,-738 # 74e0 <malloc+0x150a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d0850513          	addi	a0,a0,-760 # 74e0 <malloc+0x150a>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	c5450513          	addi	a0,a0,-940 # 7440 <malloc+0x146a>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e0050513          	addi	a0,a0,-512 # 7600 <malloc+0x162a>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e1c50513          	addi	a0,a0,-484 # 7630 <malloc+0x165a>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e3850513          	addi	a0,a0,-456 # 7660 <malloc+0x168a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d2a50513          	addi	a0,a0,-726 # 7568 <malloc+0x1592>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	c6850513          	addi	a0,a0,-920 # 74e0 <malloc+0x150a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	e6050513          	addi	a0,a0,-416 # 76f0 <malloc+0x171a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	e7850513          	addi	a0,a0,-392 # 7720 <malloc+0x174a>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	b8050513          	addi	a0,a0,-1152 # 7440 <malloc+0x146a>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	b6a50513          	addi	a0,a0,-1174 # 7440 <malloc+0x146a>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	b5450513          	addi	a0,a0,-1196 # 7440 <malloc+0x146a>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	eb058593          	addi	a1,a1,-336 # 77b0 <malloc+0x17da>
    3908:	00004517          	auipc	a0,0x4
    390c:	de850513          	addi	a0,a0,-536 # 76f0 <malloc+0x171a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	e9458593          	addi	a1,a1,-364 # 77b0 <malloc+0x17da>
    3924:	00004517          	auipc	a0,0x4
    3928:	dfc50513          	addi	a0,a0,-516 # 7720 <malloc+0x174a>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c3058593          	addi	a1,a1,-976 # 7568 <malloc+0x1592>
    3940:	00004517          	auipc	a0,0x4
    3944:	b2050513          	addi	a0,a0,-1248 # 7460 <malloc+0x148a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	d9c50513          	addi	a0,a0,-612 # 76f0 <malloc+0x171a>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	db850513          	addi	a0,a0,-584 # 7720 <malloc+0x174a>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	bec50513          	addi	a0,a0,-1044 # 7568 <malloc+0x1592>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	d9050513          	addi	a0,a0,-624 # 7720 <malloc+0x174a>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d4c50513          	addi	a0,a0,-692 # 76f0 <malloc+0x171a>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	aa850513          	addi	a0,a0,-1368 # 7460 <malloc+0x148a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f3450513          	addi	a0,a0,-204 # 7900 <malloc+0x192a>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	b8850513          	addi	a0,a0,-1144 # 7568 <malloc+0x1592>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	a6c50513          	addi	a0,a0,-1428 # 7460 <malloc+0x148a>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a3850513          	addi	a0,a0,-1480 # 7440 <malloc+0x146a>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	f5450513          	addi	a0,a0,-172 # 7970 <malloc+0x199a>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a1050513          	addi	a0,a0,-1520 # 7440 <malloc+0x146a>
    ...
    3a56:	9f650513          	addi	a0,a0,-1546 # 7448 <malloc+0x1472>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	4c4080e7          	jalr	1220(ra) # 5f1e <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	9fa50513          	addi	a0,a0,-1542 # 7468 <malloc+0x1492>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4a8080e7          	jalr	1192(ra) # 5f1e <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	9fe50513          	addi	a0,a0,-1538 # 7488 <malloc+0x14b2>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	48c080e7          	jalr	1164(ra) # 5f1e <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a1a50513          	addi	a0,a0,-1510 # 74c0 <malloc+0x14ea>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	470080e7          	jalr	1136(ra) # 5f1e <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a2e50513          	addi	a0,a0,-1490 # 74f0 <malloc+0x151a>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	454080e7          	jalr	1108(ra) # 5f1e <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a4a50513          	addi	a0,a0,-1462 # 7528 <malloc+0x1552>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	438080e7          	jalr	1080(ra) # 5f1e <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a4e50513          	addi	a0,a0,-1458 # 7548 <malloc+0x1572>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	41c080e7          	jalr	1052(ra) # 5f1e <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a6250513          	addi	a0,a0,-1438 # 7578 <malloc+0x15a2>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	400080e7          	jalr	1024(ra) # 5f1e <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a6e50513          	addi	a0,a0,-1426 # 75a0 <malloc+0x15ca>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	3e4080e7          	jalr	996(ra) # 5f1e <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a7250513          	addi	a0,a0,-1422 # 75c0 <malloc+0x15ea>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	3c8080e7          	jalr	968(ra) # 5f1e <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a7e50513          	addi	a0,a0,-1410 # 75e8 <malloc+0x1612>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3ac080e7          	jalr	940(ra) # 5f1e <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	a8a50513          	addi	a0,a0,-1398 # 7610 <malloc+0x163a>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	390080e7          	jalr	912(ra) # 5f1e <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	a9e50513          	addi	a0,a0,-1378 # 7640 <malloc+0x166a>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	374080e7          	jalr	884(ra) # 5f1e <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	aaa50513          	addi	a0,a0,-1366 # 7668 <malloc+0x1692>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	358080e7          	jalr	856(ra) # 5f1e <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	aa650513          	addi	a0,a0,-1370 # 7680 <malloc+0x16aa>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	33c080e7          	jalr	828(ra) # 5f1e <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	aaa50513          	addi	a0,a0,-1366 # 76a0 <malloc+0x16ca>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	320080e7          	jalr	800(ra) # 5f1e <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	aae50513          	addi	a0,a0,-1362 # 76c0 <malloc+0x16ea>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	304080e7          	jalr	772(ra) # 5f1e <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	ad250513          	addi	a0,a0,-1326 # 7700 <malloc+0x172a>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	2e8080e7          	jalr	744(ra) # 5f1e <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	ae650513          	addi	a0,a0,-1306 # 7730 <malloc+0x175a>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	2cc080e7          	jalr	716(ra) # 5f1e <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	aea50513          	addi	a0,a0,-1302 # 7750 <malloc+0x177a>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2b0080e7          	jalr	688(ra) # 5f1e <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	aee50513          	addi	a0,a0,-1298 # 7770 <malloc+0x179a>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	294080e7          	jalr	660(ra) # 5f1e <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	af250513          	addi	a0,a0,-1294 # 7790 <malloc+0x17ba>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	278080e7          	jalr	632(ra) # 5f1e <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b0650513          	addi	a0,a0,-1274 # 77c0 <malloc+0x17ea>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	25c080e7          	jalr	604(ra) # 5f1e <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b1250513          	addi	a0,a0,-1262 # 77e8 <malloc+0x1812>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	240080e7          	jalr	576(ra) # 5f1e <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b1e50513          	addi	a0,a0,-1250 # 7810 <malloc+0x183a>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	224080e7          	jalr	548(ra) # 5f1e <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b2a50513          	addi	a0,a0,-1238 # 7838 <malloc+0x1862>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	208080e7          	jalr	520(ra) # 5f1e <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b2e50513          	addi	a0,a0,-1234 # 7858 <malloc+0x1882>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	1ec080e7          	jalr	492(ra) # 5f1e <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b3250513          	addi	a0,a0,-1230 # 7878 <malloc+0x18a2>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	1d0080e7          	jalr	464(ra) # 5f1e <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b3e50513          	addi	a0,a0,-1218 # 78a0 <malloc+0x18ca>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	1b4080e7          	jalr	436(ra) # 5f1e <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b4250513          	addi	a0,a0,-1214 # 78c0 <malloc+0x18ea>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	198080e7          	jalr	408(ra) # 5f1e <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b4650513          	addi	a0,a0,-1210 # 78e0 <malloc+0x190a>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	17c080e7          	jalr	380(ra) # 5f1e <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b5250513          	addi	a0,a0,-1198 # 7908 <malloc+0x1932>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	160080e7          	jalr	352(ra) # 5f1e <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	7ce50513          	addi	a0,a0,1998 # 75a0 <malloc+0x15ca>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	144080e7          	jalr	324(ra) # 5f1e <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b3a50513          	addi	a0,a0,-1222 # 7928 <malloc+0x1952>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	128080e7          	jalr	296(ra) # 5f1e <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b3e50513          	addi	a0,a0,-1218 # 7948 <malloc+0x1972>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	10c080e7          	jalr	268(ra) # 5f1e <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	b5250513          	addi	a0,a0,-1198 # 7978 <malloc+0x19a2>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	0f0080e7          	jalr	240(ra) # 5f1e <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b5650513          	addi	a0,a0,-1194 # 7998 <malloc+0x19c2>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	0d4080e7          	jalr	212(ra) # 5f1e <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b4850513          	addi	a0,a0,-1208 # 79b0 <malloc+0x19da>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b3650513          	addi	a0,a0,-1226 # 79b0 <malloc+0x19da>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	95450513          	addi	a0,a0,-1708 # 67e0 <malloc+0x80a>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	56a50513          	addi	a0,a0,1386 # 7408 <malloc+0x1432>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	50050513          	addi	a0,a0,1280 # 73b0 <malloc+0x13da>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	b5650513          	addi	a0,a0,-1194 # 7a18 <malloc+0x1a42>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	b6c50513          	addi	a0,a0,-1172 # 7a40 <malloc+0x1a6a>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	aca50513          	addi	a0,a0,-1334 # 79b0 <malloc+0x19da>
    ...
    3f08:	ab450513          	addi	a0,a0,-1356 # 79b8 <malloc+0x19e2>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	012080e7          	jalr	18(ra) # 5f1e <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	ab050513          	addi	a0,a0,-1360 # 79d0 <malloc+0x19fa>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	ff6080e7          	jalr	-10(ra) # 5f1e <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	aac50513          	addi	a0,a0,-1364 # 79e8 <malloc+0x1a12>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	fda080e7          	jalr	-38(ra) # 5f1e <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	aa850513          	addi	a0,a0,-1368 # 7a00 <malloc+0x1a2a>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	fbe080e7          	jalr	-66(ra) # 5f1e <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	44450513          	addi	a0,a0,1092 # 73b8 <malloc+0x13e2>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	fa2080e7          	jalr	-94(ra) # 5f1e <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	a9050513          	addi	a0,a0,-1392 # 7a20 <malloc+0x1a4a>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	f86080e7          	jalr	-122(ra) # 5f1e <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	a9c50513          	addi	a0,a0,-1380 # 7a48 <malloc+0x1a72>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	f6a080e7          	jalr	-150(ra) # 5f1e <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	aa050513          	addi	a0,a0,-1376 # 7a68 <malloc+0x1a92>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f4e080e7          	jalr	-178(ra) # 5f1e <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	a9450513          	addi	a0,a0,-1388 # 7a88 <malloc+0x1ab2>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	a7850513          	addi	a0,a0,-1416 # 7a88 <malloc+0x1ab2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	aac50513          	addi	a0,a0,-1364 # 7ad0 <malloc+0x1afa>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	a9450513          	addi	a0,a0,-1388 # 7ad0 <malloc+0x1afa>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	a8050513          	addi	a0,a0,-1408 # 7ad0 <malloc+0x1afa>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	a6c50513          	addi	a0,a0,-1428 # 7ad0 <malloc+0x1afa>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	a5858593          	addi	a1,a1,-1448 # 7ad0 <malloc+0x1afa>
    4080:	00002517          	auipc	a0,0x2
    4084:	25050513          	addi	a0,a0,592 # 62d0 <malloc+0x2fa>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	9f450513          	addi	a0,a0,-1548 # 7a88 <malloc+0x1ab2>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	73650513          	addi	a0,a0,1846 # 67e0 <malloc+0x80a>
  ...
  fd = open(".", 0);
    ...
    40c4:	72050513          	addi	a0,a0,1824 # 67e0 <malloc+0x80a>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	09458593          	addi	a1,a1,148 # 6168 <malloc+0x192>
  ...
  close(fd);
    ...
    4104:	99050513          	addi	a0,a0,-1648 # 7a90 <malloc+0x1aba>
    4108:	00002097          	auipc	ra,0x2
    410c:	e16080e7          	jalr	-490(ra) # 5f1e <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	99450513          	addi	a0,a0,-1644 # 7ab0 <malloc+0x1ada>
    4124:	00002097          	auipc	ra,0x2
    4128:	dfa080e7          	jalr	-518(ra) # 5f1e <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9a850513          	addi	a0,a0,-1624 # 7ae0 <malloc+0x1b0a>
    4140:	00002097          	auipc	ra,0x2
    4144:	dde080e7          	jalr	-546(ra) # 5f1e <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	98c50513          	addi	a0,a0,-1652 # 7ae0 <malloc+0x1b0a>
    415c:	00002097          	auipc	ra,0x2
    4160:	dc2080e7          	jalr	-574(ra) # 5f1e <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	99850513          	addi	a0,a0,-1640 # 7b08 <malloc+0x1b32>
    4178:	00002097          	auipc	ra,0x2
    417c:	da6080e7          	jalr	-602(ra) # 5f1e <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9a450513          	addi	a0,a0,-1628 # 7b30 <malloc+0x1b5a>
    4194:	00002097          	auipc	ra,0x2
    4198:	d8a080e7          	jalr	-630(ra) # 5f1e <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9b050513          	addi	a0,a0,-1616 # 7b58 <malloc+0x1b82>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	d6e080e7          	jalr	-658(ra) # 5f1e <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9bc50513          	addi	a0,a0,-1604 # 7b80 <malloc+0x1baa>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d52080e7          	jalr	-686(ra) # 5f1e <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9c050513          	addi	a0,a0,-1600 # 7ba0 <malloc+0x1bca>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d36080e7          	jalr	-714(ra) # 5f1e <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9cc50513          	addi	a0,a0,-1588 # 7bc8 <malloc+0x1bf2>
    4204:	00002097          	auipc	ra,0x2
    4208:	d1a080e7          	jalr	-742(ra) # 5f1e <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	9b0a0a13          	addi	s4,s4,-1616 # 7be0 <malloc+0x1c0a>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4b048493          	addi	s1,s1,1200 # 76e8 <malloc+0x1712>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	090a8a93          	addi	s5,s5,144 # 62d0 <malloc+0x2fa>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	89098993          	addi	s3,s3,-1904 # 7ad8 <malloc+0x1b02>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	99450513          	addi	a0,a0,-1644 # 7be8 <malloc+0x1c12>
    425c:	00002097          	auipc	ra,0x2
    4260:	cc2080e7          	jalr	-830(ra) # 5f1e <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	99050513          	addi	a0,a0,-1648 # 7c00 <malloc+0x1c2a>
    4278:	00002097          	auipc	ra,0x2
    427c:	ca6080e7          	jalr	-858(ra) # 5f1e <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	10498993          	addi	s3,s3,260 # 7408 <malloc+0x1432>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	8d490913          	addi	s2,s2,-1836 # 7be0 <malloc+0x1c0a>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	08450513          	addi	a0,a0,132 # 73b0 <malloc+0x13da>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	8bc50513          	addi	a0,a0,-1860 # 7c18 <malloc+0x1c42>
  ...
  if(pid == 0){
    ...
    4384:	89850513          	addi	a0,a0,-1896 # 7c18 <malloc+0x1c42>
    ...
    439a:	8a250513          	addi	a0,a0,-1886 # 7c38 <malloc+0x1c62>
    439e:	00002097          	auipc	ra,0x2
    43a2:	b80080e7          	jalr	-1152(ra) # 5f1e <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	86e50513          	addi	a0,a0,-1938 # 7c20 <malloc+0x1c4a>
    43ba:	00002097          	auipc	ra,0x2
    43be:	b64080e7          	jalr	-1180(ra) # 5f1e <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	5b250513          	addi	a0,a0,1458 # 6980 <malloc+0x9aa>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b48080e7          	jalr	-1208(ra) # 5f1e <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	81c50513          	addi	a0,a0,-2020 # 7c18 <malloc+0x1c42>
    ...
    4414:	76050513          	addi	a0,a0,1888 # 6b70 <malloc+0xb9a>
    4418:	00002097          	auipc	ra,0x2
    441c:	b06080e7          	jalr	-1274(ra) # 5f1e <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	81250513          	addi	a0,a0,-2030 # 7c60 <malloc+0x1c8a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	7e650513          	addi	a0,a0,2022 # 7c60 <malloc+0x1c8a>
  ...
  sleep(10); // one second
    ...
    44b6:	68e50513          	addi	a0,a0,1678 # 6b40 <malloc+0xb6a>
    44ba:	00002097          	auipc	ra,0x2
    44be:	a64080e7          	jalr	-1436(ra) # 5f1e <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	79448493          	addi	s1,s1,1940 # 7c60 <malloc+0x1c8a>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	76c50513          	addi	a0,a0,1900 # 7c60 <malloc+0x1c8a>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	40650513          	addi	a0,a0,1030 # 6980 <malloc+0x9aa>
    4582:	00002097          	auipc	ra,0x2
    4586:	99c080e7          	jalr	-1636(ra) # 5f1e <printf>
      exit(1);
    458a:	4505                	li	a0,1
    ...
    45a4:	6d050513          	addi	a0,a0,1744 # 7c70 <malloc+0x1c9a>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	976080e7          	jalr	-1674(ra) # 5f1e <printf>
       exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	56050513          	addi	a0,a0,1376 # 6b40 <malloc+0xb6a>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	936080e7          	jalr	-1738(ra) # 5f1e <printf>
    exit(1);
    45f0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4612:	37250513          	addi	a0,a0,882 # 6980 <malloc+0x9aa>
    4616:	00002097          	auipc	ra,0x2
    461a:	908080e7          	jalr	-1784(ra) # 5f1e <printf>
    exit(1);
    461e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4656:	b1658593          	addi	a1,a1,-1258 # 6168 <malloc+0x192>
    ...
    4680:	30450513          	addi	a0,a0,772 # 6980 <malloc+0x9aa>
    4684:	00002097          	auipc	ra,0x2
    4688:	89a080e7          	jalr	-1894(ra) # 5f1e <printf>
     exit(1);
    468c:	4505                	li	a0,1
    ...
    469c:	5f850513          	addi	a0,a0,1528 # 7c90 <malloc+0x1cba>
    46a0:	00002097          	auipc	ra,0x2
    46a4:	87e080e7          	jalr	-1922(ra) # 5f1e <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	5d450513          	addi	a0,a0,1492 # 7ca8 <malloc+0x1cd2>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	842080e7          	jalr	-1982(ra) # 5f1e <printf>
}
  ...
  printf("kill... ");
    ...
    4704:	5c050513          	addi	a0,a0,1472 # 7cc0 <malloc+0x1cea>
    4708:	00002097          	auipc	ra,0x2
    470c:	816080e7          	jalr	-2026(ra) # 5f1e <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4732:	5a250513          	addi	a0,a0,1442 # 7cd0 <malloc+0x1cfa>
    4736:	00001097          	auipc	ra,0x1
    473a:	7e8080e7          	jalr	2024(ra) # 5f1e <printf>
  wait(0);
    473e:	4501                	li	a0,0
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	1d250513          	addi	a0,a0,466 # 6980 <malloc+0x9aa>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	768080e7          	jalr	1896(ra) # 5f1e <printf>
      exit(1);
    47be:	4505                	li	a0,1
    ...
    47ce:	33e50513          	addi	a0,a0,830 # 6b08 <malloc+0xb32>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	74c080e7          	jalr	1868(ra) # 5f1e <printf>
        exit(1);
    47da:	4505                	li	a0,1
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	24850513          	addi	a0,a0,584 # 6a88 <malloc+0xab2>
    4848:	00001097          	auipc	ra,0x1
    484c:	6d6080e7          	jalr	1750(ra) # 5f1e <printf>
    exit(1);
    4850:	4505                	li	a0,1
    ...
    4878:	8f458593          	addi	a1,a1,-1804 # 6168 <malloc+0x192>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	3a850513          	addi	a0,a0,936 # 7ce0 <malloc+0x1d0a>
    4940:	00001097          	auipc	ra,0x1
    4944:	5de080e7          	jalr	1502(ra) # 5f1e <printf>
    exit(1);
    4948:	4505                	li	a0,1
    ...
    4958:	02c50513          	addi	a0,a0,44 # 6980 <malloc+0x9aa>
    495c:	00001097          	auipc	ra,0x1
    4960:	5c2080e7          	jalr	1474(ra) # 5f1e <printf>
    exit(1);
    4964:	4505                	li	a0,1
    ...
    49a4:	36050513          	addi	a0,a0,864 # 7d00 <malloc+0x1d2a>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	576080e7          	jalr	1398(ra) # 5f1e <printf>
    exit(1);
    49b0:	4505                	li	a0,1
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	5cc080e7          	jalr	1484(ra) # 5fd6 <malloc>
    ...
    4a48:	2ec50513          	addi	a0,a0,748 # 7d30 <malloc+0x1d5a>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	4d2080e7          	jalr	1234(ra) # 5f1e <printf>
      exit(1);
    4a54:	4505                	li	a0,1
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	26650513          	addi	a0,a0,614 # 7d60 <malloc+0x1d8a>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	41c080e7          	jalr	1052(ra) # 5f1e <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    ...
    4b1a:	27250513          	addi	a0,a0,626 # 7d88 <malloc+0x1db2>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	400080e7          	jalr	1024(ra) # 5f1e <printf>
      exit(1);
    4b26:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	1f650513          	addi	a0,a0,502 # 7d50 <malloc+0x1d7a>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	20e50513          	addi	a0,a0,526 # 7da8 <malloc+0x1dd2>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	37c080e7          	jalr	892(ra) # 5f1e <printf>
    exit(1);
    4baa:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bda:	17a50513          	addi	a0,a0,378 # 7d50 <malloc+0x1d7a>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	1d450513          	addi	a0,a0,468 # 7dd0 <malloc+0x1dfa>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	31a080e7          	jalr	794(ra) # 5f1e <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	1a878793          	addi	a5,a5,424 # 7de8 <malloc+0x1e12>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	1a478793          	addi	a5,a5,420 # 7df0 <malloc+0x1e1a>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	1a078793          	addi	a5,a5,416 # 7df8 <malloc+0x1e22>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	19c78793          	addi	a5,a5,412 # 7e00 <malloc+0x1e2a>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	0b650513          	addi	a0,a0,182 # 6d88 <malloc+0xdb2>
    4cda:	00001097          	auipc	ra,0x1
    4cde:	244080e7          	jalr	580(ra) # 5f1e <printf>
      exit(1);
    4ce2:	4505                	li	a0,1
    ...
    4d50:	0bc50513          	addi	a0,a0,188 # 7e08 <malloc+0x1e32>
    4d54:	00001097          	auipc	ra,0x1
    4d58:	1ca080e7          	jalr	458(ra) # 5f1e <printf>
        exit(1);
    4d5c:	4505                	li	a0,1
    ...
    4d6a:	0b250513          	addi	a0,a0,178 # 7e18 <malloc+0x1e42>
    4d6e:	00001097          	auipc	ra,0x1
    4d72:	1b0080e7          	jalr	432(ra) # 5f1e <printf>
          exit(1);
    4d76:	4505                	li	a0,1
    ...
    4d90:	0a450513          	addi	a0,a0,164 # 7e30 <malloc+0x1e5a>
    4d94:	00001097          	auipc	ra,0x1
    4d98:	18a080e7          	jalr	394(ra) # 5f1e <printf>
          exit(1);
    4d9c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	02c50513          	addi	a0,a0,44 # 7e40 <malloc+0x1e6a>
    4e1c:	00001097          	auipc	ra,0x1
    4e20:	102080e7          	jalr	258(ra) # 5f1e <printf>
      exit(1);
    4e24:	4505                	li	a0,1
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	fe2b8b93          	addi	s7,s7,-30 # 7e58 <malloc+0x1e82>
  for(i = 0; i < N; i++){
    ...
    4ebc:	fa850513          	addi	a0,a0,-88 # 7e60 <malloc+0x1e8a>
    4ec0:	00001097          	auipc	ra,0x1
    4ec4:	05e080e7          	jalr	94(ra) # 5f1e <printf>
        exit(1);
    4ec8:	4505                	li	a0,1
    ...
    4eda:	f8250513          	addi	a0,a0,-126 # 7e58 <malloc+0x1e82>
  ...
  fd = open(".", 0);
    ...
    4f12:	8d250513          	addi	a0,a0,-1838 # 67e0 <malloc+0x80a>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	efa50513          	addi	a0,a0,-262 # 7e80 <malloc+0x1eaa>
    4f8e:	00001097          	auipc	ra,0x1
    4f92:	f90080e7          	jalr	-112(ra) # 5f1e <printf>
        exit(1);
    4f96:	4505                	li	a0,1
    ...
    4faa:	efa50513          	addi	a0,a0,-262 # 7ea0 <malloc+0x1eca>
    4fae:	00001097          	auipc	ra,0x1
    4fb2:	f70080e7          	jalr	-144(ra) # 5f1e <printf>
        exit(1);
    4fb6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	eea50513          	addi	a0,a0,-278 # 7ec8 <malloc+0x1ef2>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	f38080e7          	jalr	-200(ra) # 5f1e <printf>
    exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffe:	98650513          	addi	a0,a0,-1658 # 6980 <malloc+0x9aa>
    5002:	00001097          	auipc	ra,0x1
    5006:	f1c080e7          	jalr	-228(ra) # 5f1e <printf>
      exit(1);
    500a:	4505                	li	a0,1
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	cd450513          	addi	a0,a0,-812 # 7f00 <malloc+0x1f2a>
  ...
  for(i = 0; ; i++){
    ...
    5294:	c8050513          	addi	a0,a0,-896 # 7f10 <malloc+0x1f3a>
    5298:	00001097          	auipc	ra,0x1
    529c:	c86080e7          	jalr	-890(ra) # 5f1e <printf>
    exit(1);
    52a0:	4505                	li	a0,1
    ...
    52b0:	c8450513          	addi	a0,a0,-892 # 7f30 <malloc+0x1f5a>
    ...
    52cc:	c8850513          	addi	a0,a0,-888 # 7f50 <malloc+0x1f7a>
    52d0:	00001097          	auipc	ra,0x1
    52d4:	c4e080e7          	jalr	-946(ra) # 5f1e <printf>
    exit(1);
    52d8:	4505                	li	a0,1
    ...
    52e8:	c8c50513          	addi	a0,a0,-884 # 7f70 <malloc+0x1f9a>
    52ec:	00001097          	auipc	ra,0x1
    52f0:	c32080e7          	jalr	-974(ra) # 5f1e <printf>
      exit(1);
    52f4:	4505                	li	a0,1
    ...
    5304:	c9050513          	addi	a0,a0,-880 # 7f90 <malloc+0x1fba>
    5308:	00001097          	auipc	ra,0x1
    530c:	c16080e7          	jalr	-1002(ra) # 5f1e <printf>
      exit(1);
    5310:	4505                	li	a0,1
    ...
    5320:	c8c50513          	addi	a0,a0,-884 # 7fa8 <malloc+0x1fd2>
    5324:	00001097          	auipc	ra,0x1
    5328:	bfa080e7          	jalr	-1030(ra) # 5f1e <printf>
      exit(1);
    532c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    534e:	bb650513          	addi	a0,a0,-1098 # 7f00 <malloc+0x1f2a>
    ...
    5372:	c5a50513          	addi	a0,a0,-934 # 7fc8 <malloc+0x1ff2>
    5376:	00001097          	auipc	ra,0x1
    537a:	ba8080e7          	jalr	-1112(ra) # 5f1e <printf>
    exit(1);
    537e:	4505                	li	a0,1
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	c4450513          	addi	a0,a0,-956 # 7fe8 <malloc+0x2012>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53c8:	c34c8c93          	addi	s9,s9,-972 # 7ff8 <malloc+0x2022>
    name[0] = 'f';
    ...
    5438:	bd450513          	addi	a0,a0,-1068 # 8008 <malloc+0x2032>
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	b7e50513          	addi	a0,a0,-1154 # 8028 <malloc+0x2052>
    ...
    5504:	b1850513          	addi	a0,a0,-1256 # 8018 <malloc+0x2042>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	b0e50513          	addi	a0,a0,-1266 # 8040 <malloc+0x206a>
  ...
  if(pid == 0) {
    ...
    5566:	b0650513          	addi	a0,a0,-1274 # 8068 <malloc+0x2092>
    ...
    558a:	aca50513          	addi	a0,a0,-1334 # 8050 <malloc+0x207a>
    ...
    55b2:	ac250513          	addi	a0,a0,-1342 # 8070 <malloc+0x209a>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	a7a50513          	addi	a0,a0,-1414 # 8078 <malloc+0x20a2>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b1098993          	addi	s3,s3,-1264 # 6168 <malloc+0x192>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	a4650513          	addi	a0,a0,-1466 # 80d0 <malloc+0x20fa>
    ...
    56a8:	9ec50513          	addi	a0,a0,-1556 # 8090 <malloc+0x20ba>
    ...
    56c2:	9f250513          	addi	a0,a0,-1550 # 80b0 <malloc+0x20da>
  ...
  while(1){
    ...
    5710:	9e450513          	addi	a0,a0,-1564 # 80f0 <malloc+0x211a>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	9a2b8b93          	addi	s7,s7,-1630 # 8110 <malloc+0x213a>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	9a0d0d13          	addi	s10,s10,-1632 # 8128 <malloc+0x2152>
          return 1;
        }
      }
    }
    ...
    5794:	9b8c8c93          	addi	s9,s9,-1608 # 8148 <malloc+0x2172>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	91058593          	addi	a1,a1,-1776 # 8178 <malloc+0x21a2>
  ...
  char *justone = 0;
    ...
    588a:	8fa58593          	addi	a1,a1,-1798 # 8180 <malloc+0x21aa>
    ...
    58a0:	93458593          	addi	a1,a1,-1740 # 81d0 <malloc+0x21fa>
  ...
  int continuous = 0;
    ...
    58cc:	8c050513          	addi	a0,a0,-1856 # 8188 <malloc+0x21b2>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	8ca50513          	addi	a0,a0,-1846 # 81b8 <malloc+0x21e2>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5c9e:	8fe50513          	addi	a0,a0,-1794 # 8598 <digits>
    5ca2:	883a                	mv	a6,a4
    5ca4:	2705                	addiw	a4,a4,1
    5ca6:	02c5f7bb          	remuw	a5,a1,a2
    5caa:	1782                	slli	a5,a5,0x20
    5cac:	9381                	srli	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5e2c:	770b8b93          	addi	s7,s7,1904 # 8598 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5e80:	6bc90913          	addi	s2,s2,1724 # 8538 <malloc+0x2562>
        while(*s != 0){
    5e84:	02800593          	li	a1,40
    5e88:	bff1                	j	5e64 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    5e8a:	008b8913          	addi	s2,s7,8
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5f62:	4f27b783          	ld	a5,1266(a5) # 9450 <freep>
    ...
    5f8a:	00e6ea63          	bltu	a3,a4,5f9e <free+0x4a>
{
  ...
  freep = p;
    ...
    5fcc:	48f73423          	sd	a5,1160(a4) # 9450 <freep>
}
...
malloc(uint nbytes)
{
    ...
    5fe8:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5fea:	02051493          	slli	s1,a0,0x20
    5fee:	9081                	srli	s1,s1,0x20
    5ff0:	04bd                	addi	s1,s1,15
    5ff2:	8091                	srli	s1,s1,0x4
    5ff4:	0014899b          	addiw	s3,s1,1
    5ff8:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5ffa:	00003517          	auipc	a0,0x3
    5ffe:	45653503          	ld	a0,1110(a0) # 9450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    6026:	42e90913          	addi	s2,s2,1070 # 9450 <freep>
  if(p == (char*)-1)
    602a:	5afd                	li	s5,-1
    602c:	a895                	j	60a0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    602e:	0000a797          	auipc	a5,0xa
    6032:	c4a78793          	addi	a5,a5,-950 # fc78 <base>
    ...
    604e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6050:	02071693          	slli	a3,a4,0x20
    6054:	01c6d713          	srli	a4,a3,0x1c
    6058:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    605a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    605e:	00003717          	auipc	a4,0x3
    6062:	3ea73923          	sd	a0,1010(a4) # 9450 <freep>
      return (void*)(p + 1);
    6066:	01078513          	addi	a0,a5,16
