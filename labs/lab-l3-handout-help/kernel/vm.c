...
#define PAIDX(pa) (((void *)PHYSTOP - pa) / PGSIZE)

uint16 parefcount[NPAGE];
...
/**
 * @brief Decreases the reference count to the page pointed to by PA and frees the page
...
// Given a parent process's page table, maps
// its memory into a child's page table.
// Copies the page table and maps user memory.
